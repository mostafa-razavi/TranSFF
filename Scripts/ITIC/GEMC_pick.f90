...
double precision :: temperatures(20), press_vap(20),rho_liq(20),rho_vap(20), reduced_temperatures(20)
...
write(*,*) "Do you want to choose the temperatures manually?"
read(*,*) yesOrno
if(yesOrNo .eq. "yes" .Or. yesOrNo .eq. "YES") then
	write(*,*) "Enter number of points followed by temperatures:"
	READ(*,*)  n_points, (temperatures(i), i=1, n_points)

elseif(yesOrNo .eq. "no" .Or. yesOrNo .eq. "NO") then
	write(*,*) "Enter number of points followed by reduced temperatures"
	READ(*,*)  n_points, (reduced_temperatures(i), i=1, n_points)
	do i=1,n_points
		temperatures(i) = reduced_temperatures(i) * TC
	enddo
else
...
write(*,*) "Enter # of molecules for liquid and vapor phases:"
read(*,*) N_liquid, N_vapor

write(*,*) (temperatures(i), i=1, n_points)
...
do i=1,n_points
	call Dippr(CASN,"LDN",temperatures(i),rho_liq(i),"gm|cm^3")
	call Dippr(CASN,"VP",temperatures(i),press_vap(i),"Mpa")	
	rho_vap(i) = press_vap(i) / 8.314 / temperatures(i) * MW
	if (rho_vap(i) .le. 0.01) then
		rho_vap(i) = 0.01
	endif
enddo

write(*,'(A7,1x,30I15)') "TEMP:",(int(temperatures(i)), i=1, n_points)
write(*,'(A7,1x,30F15.4)') "RHO_L:",(rho_liq(i), i=1, n_points)
write(*,'(A7,1x,30F15.4)') "RHO_V:",(rho_vap(i), i=1, n_points)
write(*,'(A7,1x,30I15)') "NMOL_L:",(N_liquid, i=1, n_points)
write(*,'(A7,1x,30I15)') "NMOL_V:",(N_vapor, i=1, n_points)


open(87,file="RunGEMC.inp")
write(87,*)
...
write(87,'(A7,1x,30I15)') "TEMP:",(int(temperatures(i)), i=1, n_points)
write(87,'(A7,1x,30F15.4)') "RHO_L:",(rho_liq(i), i=1, n_points)
write(87,'(A7,1x,30F15.4)') "RHO_V:",(rho_vap(i), i=1, n_points)
write(87,'(A7,1x,30I15)') "NMOL_L:",(N_liquid, i=1, n_points)
write(87,'(A7,1x,30I15)') "NMOL_V:",(N_vapor, i=1, n_points)
close(87)

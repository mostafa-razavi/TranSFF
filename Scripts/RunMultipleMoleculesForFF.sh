...
ITIC_trhozures_label="$Forcefield_name TraPPE"
trimZ="no-trimZ" 
trimU="yes-trimU"
Forcefield_ext="trappeswf2-itic-razavi"
...
do 
    ...
    bash $HOME/Git/TranSFF/Scripts/ITIC/plot_vle.sh ${molec} trhozures.res $Forcefield_name "$LitsatExt" "$LitsatLabel"   # last two arguments (lit. extention and label) could be arrays
